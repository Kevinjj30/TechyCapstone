              ...
              <Grid item sm={12} md={6} xs={12} className={classes.productwrapper} >
                <div className={classes.productitem}>
                  ...
                  <Typography variant='body1' className={classes.productcontent} >
                    Buy cutting edge tech items here at Techy!
                  </Typography>
                  <Button
                    variant='contained'
                    color='secondary'
              ...
              <div className={classes.productimagesleft}>
                <Card className={classNames(classes.cardleft,classes.cardImage)}>
                    <CardMedia
                      ...
                      image={require('src/styles/images/blackberry2.png')}
                ...
                <Card className={classes.cardleft}>
                  <CardMedia
                    className={classes.leftMedia}
                    image={require('src/styles/images/redphone.jpg')}
                    title='Red phone'
                  />
                </Card>
              </div>
                ...
                <div className={classes.productimages}>
                  <Card className={classes.card}>
                      <CardMedia
                        ...
                        image={require('src/styles/images/womanphone.png')}
                        title='Paella dish'
                      />
                      <CardContent>
